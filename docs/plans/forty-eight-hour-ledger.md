...
| V243 conjured roles remembered while the bar is re-read | session 217 | no restock of conjured food or water after training | no BUY_AMMO_REAGENT_FOOD with conjures on the bar | | |
