...
| V243 conjured roles remembered while the bar is re-read | session 217 | no restock of conjured food or water after training | no BUY_AMMO_REAGENT_FOOD with conjures on the bar | **Partly**: sessions 217 and 218 still began with a restock (218: `too_far ... Kira Songshine, is a 476-yard walk`); the memory was the process's, and each session is a new one | V244 |
...
| 26 Sep 22:16 | Session 219: four deaths in 20 minutes on the road between Westbrook and Goldshire (Mangy Wolves, a Forest Spider), one of them at the body, eating at half health; durability 25%, 35 copper, the repair refused as too poor | The route walked twice to Marshal Dughan for Further Concerns, which needs A Fishy Peril, whose accept was passed over in 218 | V245; the deaths analysed (resting and reviving where it is attacked) |
| 26 Sep 21:58 | Session 218's walk up to Zaldimar Wefhellt in the Lion's Pride Inn was preempted four times by "falling" (3 minutes in the inn) before it reached him: the strip's falling flag came and went for seconds at a time while the character stood still, jumping at the stairs and the rail | It arrived and bought Arcane Missiles (190 of 225 copper; Polymorph, also 190, left). 14 falling preemptions in the mage's 30 sessions | Watching; not a large loss |
| 26 Sep 21:50 | The mage wedged inside the Westbrook Garrison for about 45 minutes (sessions 214-217): every unstick heading and the walk back out failed, the hearthstone on cooldown until 21:49 | **Corrected 22:30** (the time-sink analysis): it walked in during session 214 (21:03) to sell 4 stacks to the garrison's quartermaster, arrived with 18 stuck events, and fell on the way out; the restocks of conjured food in 215-217 started from inside the wedge, they did not cause it. The hearthstone had gone at 20:48 on a spirit healer recovery. A character wedged in geometry frees only by a teleport | V243 and V244 stop the restocks; merchants met indoors ranked lower is a candidate; watching for wedges in other buildings |
